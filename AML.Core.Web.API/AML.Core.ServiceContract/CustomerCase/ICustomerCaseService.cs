...
namespace AML.Core.ServiceContract.CustomerCase
{
    public interface ICustomerCaseService : IBaseService
    {
        ...
        CustomerCaseDTO GetDetailsByVersion(int Id,int Version);

        CustomerCaseDTO GetDetailsByCustidVersion(string Id, int Version);

        string GetDualGoodsStatus(string customerId);
        string GetMilitaryGoodsStatus(string customerId);

        List<CustomerCaseDTO> GetShareHoldersByCompanyCode(string Id);

        List<CustomerCaseDTO> GetAllVersionCases(string Id);
        ...
        List<CustomerCaseDTO> GetAll(int userId, string startDate, string endDate, string cust_type,string matchscore,int createdBy,int caseStatus,string riskLevel, string usergroupName,int clientId,string includingDuplicate);

        List<CustomerCaseDTO> GetAllCompletedCases(int userId, string startDate, string endDate, string cust_type, string matchscore, int createdBy, int caseStatus, string riskLevel,int clientId, string includingDuplicate);

        List<CustomerCaseDTO> GetAllCompletedBySearchValue(int userId, string startDate, string endDate, string cust_type, string SearchValue, string matchscore, int createdBy, int caseStatus, string riskLevel, int clientId, string includingDuplicate);

        List<CustomerCaseDTO> GetAllBySearchValue(int userId, string startDate, string endDate, string cust_type,string SearchValue, string matchscore, int createdBy, int caseStatus, string riskLevel,string usergroupName, int clientId, string includingDuplicate);
        ...
        List<CustomerCaseDTO> GetAllCaseCreatedShareHolders(int clientid, string shareholders, int userId);
        ...
        List<CustomerCaseDTO> GetCasesByGroupId(string groupId);
    }
}
