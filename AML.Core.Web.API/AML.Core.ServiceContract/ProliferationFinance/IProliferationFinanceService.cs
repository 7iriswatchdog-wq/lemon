...
namespace AML.Core.ServiceContract.ProliferationFinance
{
    public interface IProliferationFinanceService
    {
        ...
        ServiceResponse<string> SearchMilitaryGoods(string keyword);
        ...
        // MongoDB methods
        ServiceResponse<bool> SyncSearchResultsToMongo(int caseId, string productName, List<DTO.DTO.ProliferationFinance.UAEControlListDTO> chemicalHits, string pdfHits, string searchType = "Non-Chemical");
        ServiceResponse<bool> UpdateMongoHitDecision(int caseId, string searchType, string decision, string remarks);
