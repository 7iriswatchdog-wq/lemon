...
namespace AML.Core.RepositoryContract.CustomerCase
{
    public interface ICustomerCaseRepository : IBaseRepository
    {
        ...
        ServiceResponse<CustomerCaseDTO> GetDetailsByVersion(int Id, int Version);

        ServiceResponse<CustomerCaseDTO> GetDetailsByCustidVersion(string Id, int Version);

        ServiceResponse<string> GetDualGoodsStatus(string customerId);
        ServiceResponse<string> GetMilitaryGoodsStatus(string customerId);

        ServiceResponse<List<CustomerCaseDTO>> GetShareHoldersByCompanyCode(string Id);

        ServiceResponse<List<CustomerCaseDTO>> GetAllVersionCases(string Id);
        ...
        int GetCaseIdByVersion(string custId, int version);
        ...
        ServiceResponse<List<CustomerCaseDTO>> GetAll(int userId, string startDate, string endDate, string cust_type, string matchscore,int createdBy,int caseStatus,string riskLevel, string usergroupName, int clientId, string includingDuplicate);

        ServiceResponse<List<CustomerCaseDTO>> GetAllCompletedCases(int userId, string startDate, string endDate, string cust_type, string matchscore, int createdBy, int caseStatus, string riskLevel, int clientId, string includingDuplicate);

        ServiceResponse<List<CustomerCaseDTO>> GetAllBySearchValue(int userId, string startDate, string endDate, string cust_type, string searchValue, string matchscore, int createdBy, int caseStatus, string riskLevel, string usergroupName, int clientId, string includingDuplicate);

        ServiceResponse<List<CustomerCaseDTO>> GetAllCompletedBySearchValue(int userId, string startDate, string endDate, string cust_type, string searchValue, string matchscore, int createdBy, int caseStatus, string riskLevel, int clientId, string includingDuplicate);
        ...
        ServiceResponse<List<CustomerCaseDTO>> GetCompanyCode(string CompanyCode, int clientId,string CustomerType);
        ...
        ServiceResponse<List<CustomerCaseDTO>> GetCasesByGroupId(string groupId);
    }
}
