...
namespace AML.ViewModel.ViewModels.Corporate
{
    public class CorporateScreeningModel
    {
        ...
        public SelectList EmployerIndustryList { get; set; }
        public SelectList EmployerSectorList { get; set; }
        public SelectList RegistrationAuthorityList { get; set; }
        public SelectList GenderList { get; set; }
        public SelectList CounterPartyList { get; set; }
        public SelectList GoldenVisaList { get; set; }
    }
