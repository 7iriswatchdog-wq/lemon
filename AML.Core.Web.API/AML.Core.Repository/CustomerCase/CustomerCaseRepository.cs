...
namespace AML.Core.Repository.CustomerCase
 {
    public class CustomerCaseRepository : BaseRepository, ICustomerCaseRepository
    {
        ...
        { }
        public ServiceResponse<List<CustomerCaseDTO>> GetAll(int userId, string startDate, string endDate, string cust_type, string matchScore,int createdBy,int caseStatus,string riskLevel, string usergroupName, int clientId, string includingDuplicate)
        {
            ...
            try
            {
                ...
                parameters.Add("p_includingDuplicate", includingDuplicate ?? "No");
        ...
        public ServiceResponse<List<CustomerCaseDTO>> GetAllCompletedCases(int userId, string startDate, string endDate, string cust_type, string matchScore, int createdBy, int caseStatus, string riskLevel, int clientId, string includingDuplicate)
        {
            ServiceResponse<List<CustomerCaseDTO>> serviceResponse = new ServiceResponse<List<CustomerCaseDTO>>();
            try
            {
                ...
                parameters.Add("p_riskLevel", riskLevel);
                parameters.Add("p_clientId", clientId);
                parameters.Add("@p_includingDuplicate", includingDuplicate);
                //parameters.Add("p_caseChangeStatus", caseStatusChange);
        ...
        public ServiceResponse<List<CustomerCaseDTO>> GetAllBySearchValue(int userId, string startDate, string endDate, string cust_type, string searchValue, string matchScore, int createdBy, int caseStatus, string riskLevel, string usergroupName,int clientId, string includingDuplicate)
        {
            ServiceResponse<List<CustomerCaseDTO>> serviceResponse = new ServiceResponse<List<CustomerCaseDTO>>();
            try
            {
        ...
        public ServiceResponse<List<CustomerCaseDTO>> GetAllCompletedBySearchValue(int userId, string startDate, string endDate, string cust_type, string searchValue, string matchScore, int createdBy, int caseStatus, string riskLevel, int clientId, string includingDuplicate)
        {
            ServiceResponse<List<CustomerCaseDTO>> serviceResponse = new ServiceResponse<List<CustomerCaseDTO>>();
            try
            {
        ...
        public ServiceResponse<CustomerCaseDTO> GetDetailsByVersion(int Id, int Version)
        {
            ServiceResponse<CustomerCaseDTO> serviceResponse = new ServiceResponse<CustomerCaseDTO>();
            try
            {
                DynamicParameters parameters = new DynamicParameters();
                parameters.Add("@p_id", Id);
                parameters.Add("@p_version", Version);
                serviceResponse.Result = GetFirstOrDefault<CustomerCaseDTO>("get_customercase_by_id_version", parameters, commandType: CommandType.StoredProcedure);
                serviceResponse.Message = "Customer cases fetched successfully.";
                serviceResponse.Status = StaticResource.SuccessStatusCode;
            }
            catch (Exception ex)
        ...
        public ServiceResponse<CustomerCaseDTO> GetDetailsByCustidVersion(string Id, int Version)
        {
            ServiceResponse<CustomerCaseDTO> serviceResponse = new ServiceResponse<CustomerCaseDTO>();
            try
            {
                ...
                parameters.Add("@p_id", Id);
                parameters.Add("@p_version", Version);
                serviceResponse.Result = GetFirstOrDefault<CustomerCaseDTO>("get_customercase_by_custid", parameters, commandType: CommandType.StoredProcedure);
                serviceResponse.Message = "Customer cases fetched successfully.";
                serviceResponse.Status = StaticResource.SuccessStatusCode;
            }
            catch (Exception ex)
        ...
        public ServiceResponse<string> GetMilitaryGoodsStatus(string customerId)
        {
            ServiceResponse<string> serviceResponse = new ServiceResponse<string>();
            try
            {
                DynamicParameters parameters = new DynamicParameters();
                parameters.Add("@p_id", customerId);
                serviceResponse.Result = GetFirstOrDefault<string>("get_military_goods_status", parameters, commandType: CommandType.StoredProcedure);
                serviceResponse.Message = "Customer cases fetched successfully.";
                serviceResponse.Status = StaticResource.SuccessStatusCode;
            }
            catch (Exception ex)
        ...
        public ServiceResponse<List<CustomerCaseDTO>> GetAllVersionCases(string Id)
        {
            ServiceResponse<List<CustomerCaseDTO>> serviceResponse = new ServiceResponse<List<CustomerCaseDTO>>();
            try
            {
                DynamicParameters parameters = new DynamicParameters();
                parameters.Add("@p_id", Id);
                serviceResponse.Result = Get<CustomerCaseDTO>("get_all_customercase_version", parameters, commandType: CommandType.StoredProcedure).ToList();
                serviceResponse.Message = "Customer cases fetched successfully.";
                serviceResponse.Status = StaticResource.SuccessStatusCode;
            }
            catch (Exception ex)
        ...
        public int GetCaseIdByVersion(string CustId, int version)
        {
            ...
            try
            {
                ...
                parameters.Add("@p_id", CustId);
                parameters.Add("@p_version", version);
                serviceResponse.Result = ExecuteScalar("get_id_by_cust_id_by_version", parameters, commandType: CommandType.StoredProcedure).ParseInt();
                serviceResponse.Message = "Customer cases fetched successfully.";
                serviceResponse.Status = StaticResource.SuccessStatusCode;
            }
            catch (Exception ex)
        ...
        public ServiceResponse<CustomerCaseDTO> GetCaseFullDetailsByCustomerId(string _custId)
        {
            ...
            try
            {
                ...
                string sql = @"SELECT cu.group_id, cu.group_risk, cu.group_entity_of, cu.parent_id, cu.flagtype, cu.relationship, cu.company_code,
                                     ca.*, 
                                     cu.fname, cu.mname, cu.lname, 
                                     cu.cust_type, cu.customer_type,
                                     cu.type,
                                     CASE ca.status
                                        WHEN 0 THEN 'Pending'
                                        WHEN 1 THEN 'White List'
                                        WHEN 2 THEN 'Approved'
                                        WHEN 3 THEN 'Rejected'
                                        WHEN 4 THEN 'Pending with Senior Management'
                                        WHEN 5 THEN 'Auto'
                                        WHEN 6 THEN 'Pending Case Created from Daily Scheduler'
                                        WHEN 7 THEN 'On Hold'
                                        ELSE '-'
                                     END AS CaseStatus,cu.dob,cu.placeofbirth,cu.cust_id_type as cust_id_type,cu.PassportId,cu.EmiratesIdNumber
                              FROM customercase ca 
                              JOIN customermaster cu ON ca.cust_id = cu.cust_ref_id 
                              WHERE ca.cust_id = @p_cust_id AND ca.is_deleted = 0";
                serviceResponse.Result = GetFirstOrDefault<CustomerCaseDTO>(sql, parameters, commandType: CommandType.Text);
                serviceResponse.Message = "Customer cases fetched successfully.";
                serviceResponse.Status = StaticResource.SuccessStatusCode;
            }
            catch (Exception ex)
...
// End 
        ...
        public ServiceResponse<CustomerCaseDTO> GetCaseFullDetailsByCustomerId(int _custId)
        {
            ...
            try
            {
                ...
                string sql = @"SELECT cu.group_id, cu.group_risk, cu.group_entity_of, cu.parent_id, cu.flagtype, cu.relationship, cu.company_code,
                              ...
                              FROM customercase ca 
                              JOIN customermaster cu ON ca.cust_id = cu.cust_ref_id 
                              WHERE ca.id = @p_cust_id AND ca.is_deleted = 0";
                serviceResponse.Result = GetFirstOrDefault<CustomerCaseDTO>(sql, parameters, commandType: CommandType.Text);
                serviceResponse.Message = "Customer cases fetched successfully.";
                serviceResponse.Status = StaticResource.SuccessStatusCode;
            }
        ...
        public ServiceResponse<int> Create(CustomerCaseDTO _CustomerCaseDTO)
        {
            ...
            try
            {
                ...
                parameters.Add("@p_createdon", string.IsNullOrEmpty(_CustomerCaseDTO.CreatedOn) ? DateTime.Now : Convert.ToDateTime(_CustomerCaseDTO.CreatedOn));
                //parameters.Add("@p_is_duplicate", _CustomerCaseDTO.IsDuplicate);
                //parameters.Add("@p_group_id", _CustomerCaseDTO.GroupId);
                //parameters.Add("@p_group_risk", _CustomerCaseDTO.GroupRisk);
                parameters.Add("@p_parent_id", _CustomerCaseDTO.ParentID);
                //parameters.Add("@p_flagtype", _CustomerCaseDTO.FlagType);
                //parameters.Add("@p_is_pep", _CustomerCaseDTO.IsPep ? 1 : 0);
                //parameters.Add("@p_is_san", _CustomerCaseDTO.IsSan ? 1 : 0);
                //parameters.Add("@p_is_rre", _CustomerCaseDTO.IsRre ? 1 : 0);
                //parameters.Add("@p_is_ins", _CustomerCaseDTO.IsIns ? 1 : 0);
                //parameters.Add("@p_is_dd", _CustomerCaseDTO.IsDd ? 1 : 0);
                //parameters.Add("@p_is_poi", _CustomerCaseDTO.IsPoi ? 1 : 0);
                //parameters.Add("@p_is_rel", _CustomerCaseDTO.IsRel ? 1 : 0);
        ...
        public ServiceResponse<List<CustomerCaseDTO>> GetCasesByGroupId(string groupId)
        {
            ServiceResponse<List<CustomerCaseDTO>> serviceResponse = new ServiceResponse<List<CustomerCaseDTO>>();
            try
            {
                ...
                string sql = @"SELECT cu.group_id, cu.group_risk, cu.group_entity_of, cu.parent_id, cu.flagtype,
                                     ca.*, 
                                     cu.fname, cu.mname, cu.lname, 
                                     cu.cust_type, cu.customer_type,
                                     cu.type, cu.company_code, cu.version, cu.is_duplicate, cu.replaceflag, cu.updatereason,
                                     CASE ca.status
                                        WHEN 0 THEN 'Pending'
                                        WHEN 1 THEN 'White List'
                                        WHEN 2 THEN 'Approved'
                              ...
                              FROM customercase ca 
                              JOIN customermaster cu ON ca.cust_id = cu.cust_ref_id 
                              WHERE FIND_IN_SET(@p_groupId, REPLACE(cu.group_id, ' ', '')) > 0 
                                AND ca.is_deleted = 0
                                AND cu.version = (
                                    SELECT MAX(cu2.version)
                                    FROM customermaster cu2
                                    WHERE cu2.cust_ref_id = cu.cust_ref_id
                                )";
                serviceResponse.Result = Get<CustomerCaseDTO>(sql, parameters, commandType: CommandType.Text).ToList();
                serviceResponse.Message = "Group cases fetched successfully.";
                serviceResponse.Status = StaticResource.SuccessStatusCode;
            }
            catch (Exception ex)
            {
