...
namespace AML.Core.Repository.CustomerCase
{
    public class CaseCommentRepository : BaseRepository, ICaseCommentRepository
    {
        ...
        public ServiceResponse<List<CaseCommentDTO>> GetAllByCustomerId(string CustomerId)
        {
            ServiceResponse<List<CaseCommentDTO>> serviceResponse = new ServiceResponse<List<CaseCommentDTO>>();
            try
            {
                DynamicParameters parameters = new DynamicParameters();
                parameters.Add("@p_customercode", CustomerId);
                serviceResponse.Result = Get<CaseCommentDTO>("get_case_comments_by_customer_code", parameters, commandType: CommandType.StoredProcedure).ToList();
                serviceResponse.Message = "Case Comment details fetched successfully.";
                serviceResponse.Status = StaticResource.SuccessStatusCode;
            }
            catch (Exception ex)
        ...
        public ServiceResponse<int> Create(CaseCommentDTO _CaseCommentDTO)
        {
            ...
            try
            {
                ...
                if (_CaseCommentDTO.CreatedOnDB == null)
                {
                    parameters.Add("@p_createdon", null);
                }
                else
                {
                    parameters.Add("@p_createdon", _CaseCommentDTO.CreatedOnDB);
                }
                parameters.Add("@p_customerid", _CaseCommentDTO.CustomerId);
