...
namespace AML.Core.Repository.Kyc
{
    public class KycRepository : BaseRepository, IKycRepository
    {
        ...
        public ServiceResponse<string> GetRiskTypeId(KycIndividualDTO kycIndividual, CorporateKycDTO kycCorporate, string Type,string culture,int ClientIds)
        {
            ...
            try
            {
                if (kycIndividual == null) kycIndividual = new KycIndividualDTO();
                if (kycCorporate == null) kycCorporate = new CorporateKycDTO();
               ...
               // }
                ...
                parameters.Add("p_militarygoods", kycCorporate.MilitaryGoods != null && kycCorporate.MilitaryGoods != "0" ? kycCorporate.MilitaryGoods : "");
                parameters.Add("p_indmilitarygoods", kycIndividual.MilitaryGoods != null && kycIndividual.MilitaryGoods != "0" ? kycIndividual.MilitaryGoods : "");
                parameters.Add("p_moremilitarygoods", kycCorporate.MoreMilitaryGoods != null && kycCorporate.MoreMilitaryGoods != "0" ? kycCorporate.MoreMilitaryGoods : "");
                parameters.Add("p_indmoremilitarygoods", kycIndividual.MoreMilitaryGoods != null && kycIndividual.MoreMilitaryGoods != "0" ? kycIndividual.MoreMilitaryGoods : "");
