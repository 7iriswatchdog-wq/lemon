...
namespace AML.DTO.DTO.CustomerCase
{
    public class CustomerMasterDTO
    {
        ...
        public string CustPassportIssueDate { get { return PassportIssueDate.ToUIDDateFormat(); } set { PassportIssueDate = value.ParseDB(); } }
        public string CustPassportExpiryDate { get { return PassportExpiryDate.ToUIDDateFormat(); } set { PassportExpiryDate = value.ParseDB(); } }
        public string CustEmiratesIdIssueDate { get { return EmiratesIdIssueDate.ToUIDDateFormat(); } set { EmiratesIdIssueDate = value.ParseDB(); } }
        public string CustEmiratesIdExpiryDate { get { return EmiratesIdExpiryDate.ToUIDDateFormat(); } set { EmiratesIdExpiryDate = value.ParseDB(); } }
        [Column("group_entity_of")]
        ...
        public string CustDOB
        {
            ...
            set
            {
                DOB = value.ParseDB() ?? new DateTime(1900, 1, 1);
            }
        }
        [Column("created_by")]
    ...
    public class CustomerCaseDTO
    {
        ...
        public DateTime? CreatedOnDB => DateTime.TryParse(CreatedOn, out var d) ? d : (DateTime?)null;
        [Column("cif_number")]
        public string CIFNumber { get; set; }
        [Column("id_issue_date")]
        public DateTime? IdIssueDate { get; set; }
    ...
    public class CaseResponseDto
    {
        ...
        public List<string> ModeOfPayments { get; set; }


        public List<string> Professions { get; set; }

        public List<string> BusinessTypeList { get; set; }
