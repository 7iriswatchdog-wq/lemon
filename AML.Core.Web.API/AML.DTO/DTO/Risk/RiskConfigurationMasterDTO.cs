...
{
    public class RIskConfigurationMasterDTO
    {
        ...
        public List<RiskTypeCategoryDTO> AvailableRiskTypeCategory { get; set; }
        public List<RiskTypeCategoryDTO> AddedRiskTypeCategory { get; set; }

        public string RiskTypeID { get; set; }

        public string RiskTypeName { get; set; }

        public List<RiskTypeDTO> AvailableRiskType { get; set; }
        public List<RiskTypeDTO> AddedRiskType { get; set; }



        public List<RiskItemsDTO> AvailableItems { get; set; }
        public List<RiskItemsDTO> AddedItems { get; set; }


        public List<RiskTypeCategoryDTO> RiskTypeCategories { get; set; }
    ...
    public class RiskTypeDTO
    {
        ...
        public List<RiskItemsDTO> RiskItems { get; set; }
    ...
    public class RiskTypeCategoryDTO
    {
        [Column("id")]
        public int Id { get; set; }
        ...
        public List<RiskTypeDTO> RiskTypes { get; set; }

    }

    public class RiskItemsDTO
    {
        [Column("id")]
        public int Id { get; set; }
