...
namespace AML.Core.Service.CustomerMaster
{
    public class CustomerMasterService: BaseService, ICustomerMasterService
    {
        ...
        {
            _customerMasterRepository.UpdateGroupInfo(numericId, groupId, groupRisk, isDuplicate, groupEntityOf);
        }

        public IEnumerable<CustomerCaseDTO> GetAllGroupEntities(int clientId)
        {
            return _customerMasterRepository.GetAllGroupEntities(clientId);
        }
        ...
        public int UpdateCustomerMaster(CustomerMasterDTO model)
        {
            

            return _customerMasterRepository.UpdateCustomerMaster(model).Result;
        }
